        ...
        >
          <div className="space-y-4 p-2 md:p-4 border border-stone-700 rounded-md">
            <div className="space-y-1">
              ...
              <p className="text-xs text-stone-400">Convert images to ASCII art. Download as image or copy as text.</p>
              ...
              <div className="space-y-3 pt-4 border-t border-stone-700">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="outline"
                    className="flex-1 bg-stone-800 hover:bg-stone-700 text-stone-300 border-stone-600"
